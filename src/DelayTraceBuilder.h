/* Copyright (C) 2014-2016 Stavros Aronis
 *
...
#include <config.h>
#ifndef __DELAY_TRACE_BUILDER_H__
#define __DELAY_TRACE_BUILDER_H__

#include "TSOPSOTraceBuilder.h"
#include "VClock.h"

class DelayTraceBuilder : public TSOPSOTraceBuilder{
public:
  DelayTraceBuilder(const Configuration &conf = Configuration::default_conf);
  virtual ~DelayTraceBuilder();
